...
4. Point `todo.md` at `audit/FINDINGS.md` and `audit/ISSUES.md` for security work. You may keep remaining product-gap bullets (quote-aware tokens, Ctrl+R, ranking, speed).

**Allowed files:** `README.md`, `todo.md`. Do not edit `LICENSE` text. Do not edit `audit/FINDINGS.md` except if a link needs a filename fix.
...
- `todo.md` links to the audit docs
